<h2><a href="https://www.geeksforgeeks.org/problems/minimum-number-of-jumps-1587115620/1?_gl=1*1qr6p06*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw5onGBhDeARIsAFK6QJaNIf7NjfkkntJGM8wyR7c_dptiYaLO-gQHqL6BkENCbcRxIWKzfecaAkh0EALw_wcB&gbraid=0AAAAAC9yBkDHT7wZbL5vbnn_yERQgJe0U">Minimum Jumps</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given an array <strong>arr[]</strong> of non-negative numbers. Each number tells you the <strong>maximum number of steps</strong> you can jump forward from that position.</span></p>
